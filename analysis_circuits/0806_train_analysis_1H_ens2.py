...
# ------------------------------------------------------------------
    ...
    def train(self, early_stop_corr=0.995):
        ...
        #self._calculate_explained_variance_snapshot(snapshot_key='start')
        epoch = 0
    ...
    def plot_all(self):
        ...
        self.plot_raw_projection_evolution() # <--- ADD THIS LINE
...
if __name__ == "__main__":
    ...
    config = {
        ...
        'device_id': 0,
        'gamma': 10.0,
        'save_dir': "/home/goring/OnlineSGD/results_ana/1806_parity_relu_Radam_d200_k4_g10_2"
    }
