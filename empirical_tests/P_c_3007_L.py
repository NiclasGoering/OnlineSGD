...
if __name__ == "__main__":
    output_dir = "/home/goring/OnlineSGD/empirical_tests/3107_MCMCd50k6" 
    activation_choice = 'relu'
    S = tuple(range(6)) # Target parity on first 4 features, |S|=4
    kappa_0_values = np.logspace(5, -5, 25) # Extended range to test stability
